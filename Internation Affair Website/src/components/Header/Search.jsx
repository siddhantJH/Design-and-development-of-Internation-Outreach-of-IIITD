...
function Search() {
  return (
    <div className="flex w-full items-center space-x-2 md:w-1/5">
      <input
        className="flex h-8 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
        type="email"
        placeholder="Search"
      ></input>
      <button
